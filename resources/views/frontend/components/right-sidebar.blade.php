                        ...
                        <div class="col-md-3 col-sm-3 blog-sidebar">
                            ...
                            <div class="recent-news margin-bottom-10">
                                <div class="row margin-bottom-10">
                                    <div class="col-md-3">
                                        <img class="img-responsive" alt=""
                                            src="{{asset('assets/pages/img/people/img2-large.jpg')}}">
                                    </div>
                                ...
                                <div class="row margin-bottom-10">
                                    <div class="col-md-3">
                                        <img class="img-responsive" alt=""
                                            src="{{asset('assets/pages/img/people/img1-large.jpg')}}">
                                    </div>
                                    <div class="col-md-9 recent-news-inner">
                                ...
                                <div class="row margin-bottom-10">
                                    <div class="col-md-3">
                                        <img class="img-responsive" alt=""
                                            src="{{asset('assets/pages/img/people/img3-large.jpg')}}">
                                    </div>
                                    <div class="col-md-9 recent-news-inner">
                                ...
                                <div class="tab-style-1">
                                    ...
                                    <div class="tab-content">
                                        <div id="tab-1" class="tab-pane row-fluid fade in active">
                                            <p class="margin-bottom-10">Raw denim you probably haven't heard of them jean
                                                shorts Austin. eu banh mi, qui irure terry richardson ex squid Aliquip
                                        ...
                                        <div id="tab-2" class="tab-pane fade">
                                            <p>Food truck fixie locavore, accusamus mcsweeney's marfa nulla single-origin
                                                coffee squid. aliquip jean shorts ullamco ad vinyl aesthetic magna delectus
                                                mollit. Keytar helvetica VHS salvia..</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="blog-photo-stream margin-bottom-20">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="javascript:;"><img alt="" src="{{asset('assets/pages/img/pics/img1-large.jpg')}}"></a></li>
                                    <li><a href="javascript:;"><img alt="" src="{{asset('assets/pages/img/pics/img2-large.jpg')}}"></a></li>
